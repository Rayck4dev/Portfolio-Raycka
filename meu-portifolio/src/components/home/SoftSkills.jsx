...
function SkillCard({ icon, name }) {
  return (
    <div
      className="
        group bg-black/30 backdrop-blur-md border border-neonBlue/40 rounded-xl 
        p-6 sm:p-8 text-center text-white font-medium
      ...
      "
    >
      <div className="text-3xl sm:text-4xl mb-3 sm:mb-4 text-neonBlue drop-shadow-[0_0_10px_#00C2FF] group-hover:scale-110 transition-transform duration-300">
        {icon}
      </div>

      <span className="text-base sm:text-xl font-orbitron drop-shadow-[0_0_10px_#00C2FF]">
        {name}
      </span>
    </div>
  );
